...
namespace YoElectronicShop.Api.Data
{
    public class YoElectronicShopDBContext : DbContext
    {
        public YoElectronicShopDBContext(DbContextOptions<YoElectronicShopDBContext> options) : base(options)
        {
        }
        ...
        public DbSet<CartItem> CartIterms{ get; set; }
